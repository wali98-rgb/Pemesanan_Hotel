                    ...
                    <table>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="img/<?php echo $dat['photo_city']; ?>" alt="<?php echo $dat['name_city']; ?>">
                                    </td>
                                    <td><?php echo $dat['name_city']; ?></td>
                                    <td>
                                        <a href="edit.php?id=<?php echo $dat['id_city']; ?>"><i class="bi bi-pencil"></i></a>
                                        <a href="delete.php?id=<?php echo $dat['id_city']; ?>"><i class="bi bi-trash"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
                            ...
                            ?>
                            <tr>
                                <td colspan="4">Tidak ada kota yang diinput.</td>
                            </tr>
                        <?php
                        }
                        ?>
